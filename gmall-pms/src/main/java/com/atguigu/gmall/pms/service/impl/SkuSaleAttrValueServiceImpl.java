...
public class SkuSaleAttrValueServiceImpl extends ServiceImpl<SkuSaleAttrValueDao, SkuSaleAttrValueEntity> implements SkuSaleAttrValueService {
    ...
    @Override
    public List<SkuSaleAttrValueEntity> queryAttrValueEntities(Long spuId) {
        ...
        List<SkuSaleAttrValueEntity> salesEntities = this.list(new QueryWrapper<SkuSaleAttrValueEntity>().in("sku_id", skuIds));
