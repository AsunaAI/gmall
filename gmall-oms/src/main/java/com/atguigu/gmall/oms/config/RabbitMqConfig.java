...
public class RabbitMqConfig {
    ...
    public Binding ttlBinding() {
        return new Binding("ORDER-TTL-QUEUE", Binding.DestinationType.QUEUE, "GMALL_ORDER_EXCHANGE", "order.ttl", null);
    }
    ...
    public Binding deadBinding() {
        return new Binding("ORDER-DEAD-QUEUE", Binding.DestinationType.QUEUE, "GMALL_ORDER_EXCHANGE", "order.dead", null);
    }
}
